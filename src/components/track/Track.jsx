...
export const Track = () => {
  ...
  return (
    ...
    // </section>
    <>
        <div className="flex flex-row justify-evenly items-center gap-1 mx-1 my-6 z-0">
          {trackData.map((card) => (
            <StyledSmallCard>
              <SmallCardHeadding>{card.headding}</SmallCardHeadding>
